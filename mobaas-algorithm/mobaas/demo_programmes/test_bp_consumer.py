...
'''
BP Consumer. Uses a test consumer with some small configuration.
'''
...
def main():
    ...
    test_consumer_obj = test_consumer.TestConsumer("BP Test Consumer", config.TEST_BP_MESSAGES, config.WAIT_BETWEEN_SENDS_BP)
